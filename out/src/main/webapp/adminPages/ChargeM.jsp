    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/out/insertFee" method="post">
                    <div class="form-group">
                        <label for="项目id" class="control-label">项目id</label>
                        <input type="text" class="form-control" name="projectid" id="项目id">
                    </div>
                    <div class="form-group">
                        <label for="实施ID" class="control-label">实施ID</label>
                        <input type="text" class="form-control" name="projectname" id="实施ID">
                    </div>
                    <div class="form-group">
                        <label for="项目预算" class="control-label">项目预算</label>
                        <input type="text" class="form-control" name="overview" id="项目预算">
                    </div>
                    <div class="form-group">
                        <label for="实施费用" class="control-label">实施费用</label>
                        <input type="text" class="form-control" name="doc" id="实施费用" />
                    </div>
                    <div class="form-group">
