...
<form class="form-horizontal" action="/out/insertImple" method="post">
 	<div class="form-group">
 		...
 		<div class="col-sm-6">
 			<input type="text" autofocus required name="impleid" id="lastname"placeholder="实施人员编号" class="form-control a">
 		</div>
 	</div>

 	<div class="form-group">
 		<label for="lastname1" class="col-sm-3 control-label">
 			实施人员姓名
 		</label>
 		<div class="col-sm-6">
 			<input type="text" autofocus required name="implename" id="lastname1" placeholder="实施人员姓名" class="form-control a">
 		</div>
 	</div>
 	...
 	<div class="form-group">
 		...
 		<div class="col-sm-6">
 			<input type="text" autofocus required name="projectid" id="lastname2" placeholder="相关项目编号" class="form-control a">
 		</div>
 	</div>
